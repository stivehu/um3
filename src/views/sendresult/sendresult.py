...
class Ui_sendresultForm(object):
    def setupUi(self, sendresultForm):
        ...
        self.startnumLineEdit = QtWidgets.QLineEdit(parent=sendresultForm)
        ...
        self.firstnameLineEdit = QtWidgets.QLineEdit(parent=sendresultForm)
        ...
        self.lastnameLineEdit = QtWidgets.QLineEdit(parent=sendresultForm)
        ...
        self.lastnameLabel = QtWidgets.QLabel(parent=sendresultForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.timestampLabel = QtWidgets.QLabel(parent=sendresultForm)
        font = QtGui.QFont()
        font.setPointSize(24)
        ...
        self.firstnameLabel = QtWidgets.QLabel(parent=sendresultForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.startNumLabel = QtWidgets.QLabel(parent=sendresultForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.timestampLineEdit = QtWidgets.QLineEdit(parent=sendresultForm)
