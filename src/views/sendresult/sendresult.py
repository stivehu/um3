# Form implementation generated from reading ui file 'src/views/sendresult/sendresult.ui'
#
...
class Ui_sendresultForm(object):
    def setupUi(self, sendresultForm):
        ...
        sendresultForm.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
        sendresultForm.resize(900, 300)
        ...
        self.resultGroupBox = QtWidgets.QGroupBox(parent=sendresultForm)
        self.resultGroupBox.setObjectName("resultGroupBox")
        self.gridLayout = QtWidgets.QGridLayout(self.resultGroupBox)
        self.gridLayout.setVerticalSpacing(6)
        self.gridLayout.setObjectName("gridLayout")
        self.startNumLabel = QtWidgets.QLabel(parent=self.resultGroupBox)
        ...
        self.startnumLineEdit = QtWidgets.QLineEdit(parent=self.resultGroupBox)
        ...
        self.lastnameLabel = QtWidgets.QLabel(parent=self.resultGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lastnameLineEdit = QtWidgets.QLineEdit(parent=self.resultGroupBox)
        ...
        self.firstnameLabel = QtWidgets.QLabel(parent=self.resultGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.firstnameLineEdit = QtWidgets.QLineEdit(parent=self.resultGroupBox)
        ...
        self.timestampLabel = QtWidgets.QLabel(parent=self.resultGroupBox)
        font = QtGui.QFont()
        font.setPointSize(24)
        self.timestampLabel.setFont(font)
        self.timestampLabel.setObjectName("timestampLabel")
        self.gridLayout.addWidget(self.timestampLabel, 3, 0, 1, 1)
        self.timestampLineEdit = QtWidgets.QLineEdit(parent=self.resultGroupBox)
        ...
        self.gridLayout.addWidget(self.timestampLineEdit, 3, 1, 1, 1)
        self.verticalLayout.addWidget(self.resultGroupBox)
        self.closePushButton = QtWidgets.QPushButton(parent=sendresultForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.statusBar = QtWidgets.QLabel(parent=sendresultForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, sendresultForm):
        ...
        self.resultGroupBox.setTitle(_translate("sendresultForm", "Result"))
        ...
        self.closePushButton.setText(_translate("sendresultForm", "Close"))
